...
namespace GhostscriptSharp
{
	...
	public class GhostscriptWrapper
	{
        ...
        /// at the output path
        /// </summary>
        public static byte[] GetPageThumb(string inputPath, string outputPath, int page, int width, int height)
        {
            GeneratePageThumbs(inputPath, outputPath, page, page, width, height);
            //System.Drawing.Image i = System.Drawing.Image.FromFile(outputPath);
            //Bitmap b = Bitmap.FromFile(outputPath);
            //b.
        ...
        private static byte[] ReadImage(string postedImageFileName)
        {

            try
            {
                FileInfo file = new FileInfo(postedImageFileName);
                FileStream fs = new FileStream(postedImageFileName, FileMode.Open, FileAccess.Read);
        ...
        private static byte[] ReadImages(string p_postedImageFileName, string[] p_fileType)
        {
