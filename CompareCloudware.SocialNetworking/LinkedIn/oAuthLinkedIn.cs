...
namespace CompareCloudware.SocialNetworking
{
    ...
    public class OAuthLinkedIn : oAuthBase
    {
        ...
        private string _consumerKey = ConfigurationManager.AppSettings["LinkedInConsumerKey"];
        private string _consumerSecret = ConfigurationManager.AppSettings["LinkedInConsumerSecret"];

        //THESE CHANGE ON A PERIODIC BASIS
        ...
        private string _oAuthUserToken = ConfigurationManager.AppSettings["LinkedInAccessToken"];
        private string _oAuthUserTokenSecret = ConfigurationManager.AppSettings["LinkedInAccessTokenSecret"];
