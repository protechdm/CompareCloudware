...
{
    public class ValidateFirstNameAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (searchInputModel.Forename == ViewModelHelpers.FORENAME_ERROR_MESSAGE)
            {
                ErrorMessage = ViewModelHelpers.FORENAME_ERROR_MESSAGE;
