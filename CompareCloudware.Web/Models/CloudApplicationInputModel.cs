...
{
    public class CloudApplicationInputModel : BaseModel //: CloudApplicationModel
    {
        ...
        public CloudApplicationInputModel(ICustomSession session)
        {
            ...
            CloudApplicationProductReviewsContainerModel = new CloudApplicationProductReviewsContainerModel();
            CloudApplicationVideosContainerModel = new CloudApplicationVideosContainerModel();
            ...
            CloudApplicationDocumentsContainerModel = new CloudApplicationDocumentsContainerModel();
        ...
        [Display(Name = "Cost per annum:"), Range(0,9999,ErrorMessage="Cost per annum units must be a value between 0 and 9999")]
        ...
        [Display(Name = "From:"), Range(0,9999,ErrorMessage="Cost per annum 'from' units must be a value between 0 and 9999")]
        [Required(ErrorMessage = "Cost per annum units is required")]
        ...
        [Display(Name = "To:"), Range(0,9999,ErrorMessage="Cost per annum 'to' units must be a value between 0 and 9999")]
        [Required(ErrorMessage = "Cost per annum units is required")]
        ...
        //[Display(Name = "Try URL:"), MaxLength(1000)]
        public string TryURL { get; set; }
        //[Display(Name = "Buy URL:"), MaxLength(1000)]
    ...
    public class SelectListItemCollection
    {
        ...
        public bool CanInputOther { get; set; }
        public bool OtherIsNumeric { get; set; }
        ...
        [Display(Name = "Other:")]
        public bool OtherIsSelected { get; set; }
        public string Other { get; set; }
        [Display(Name = "Other:"),Range(0,999)]
        public int OtherNumeric { get; set; }

        public bool HasUnlimitedOption { get; set; }
        [Display(Name = "Unlimited:")]
        public bool IsUnlimited { get; set; }
    
    }

    public class SelectListItemCollectionSupportTypes
    {
        public List<SelectListItemSupportType> SelectListItems { get; set; }
        public int ColumnCount { get; set; }
        public string CollectionTitle { get; set; }
        public bool MultiSelect { get; set; }
        public string ChosenValue { get; set; }
    ...
    public class SelectListItemSupportType : SelectListItem
    {
        public bool IsPassive { get; set; }
    }


    public class SelectListItemCollectionFeatures
    {
        public List<SelectListItemFeature> SelectListItems { get; set; }
        public int ColumnCount { get; set; }
        public string CollectionTitle { get; set; }
        public bool MultiSelect { get; set; }
        public string ChosenValue { get; set; }
    ...
    public class SelectListItemFeature : SelectListItem
    {
        [Display(Name = "Include At Extra Cost:")]
        public bool IncludeExtraCost { get; set; }
        [Display(Name = "Cost:"),Range(0,999)]
        //[UIHint("MonetaryTextBox")]
        public int CostWhole { get; set; }
        //[UIHint("MonetaryTextBox")]
        [Display(Name = "."),Range(0,99)]
        public int CostFraction { get; set; }

        [Display(Name = "Count:"), Range(0, 16384)]
        public int Count { get; set; }


        //[UIHint("OneToFiveWithHalves"), DisplayName("Suffix"), Display(Name = "Suffix")]
        //[Display(Name = "Suffix:"), MaxLength(10)]
        ...
        public bool HasBooleanAndCount { get; set; }
        public string OutputDisplayDescriptor { get; set; }

        public SelectListItemCollection CountSuffixes { get; set; }
