...
(function ($) {
    ...
    $.imgAreaSelect = function (img, options) {
        ...
        function update(resetKeyPress) {
            ...
            $box.css({ left: viewX(selection.x1 + 0), top: viewY(selection.y1 + 0) })
            .add($area).width(w = selection.width + 0).height(h = selection.height + 0);
