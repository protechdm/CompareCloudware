...
namespace CompareCloudware.Web.Helpers
{
    public class ModelHelpers
    {
        ...
        public static SearchPageModel RequerySearchResults(SearchPageModel model, int? oldCategory, int? newCategory, ICustomSession customSession, ICompareCloudwareRepository repository, ILogger Logger, ISiteAnalyticsLogger siteAnalyticsLogger, Controller controller)
        {
            ...
            model.ContainerModel.SearchResultsModel.SearchResultsModelOneColumn.SearchResults = GetSearchResultsModel(GetSearchResults(model,customSession, repository,Logger,siteAnalyticsLogger).ToList(),customSession);
    ...
    .Select(x => new SearchFilterModelOneColumn(customSession)
    {
        ...
        public static IQueryable<CloudApplication> GetSearchResults(SearchPageModel searchModel, ICustomSession customSession, ICompareCloudwareRepository repository, ILogger Logger, ISiteAnalyticsLogger siteAnalyticsLogger)
        //private IEnumerable<SearchResultModelOneColumn> GetSearchResults(SearchPageModel searchModel)
        {
            ...
            var searchResults = SearchProducts(searchModel.ContainerModel.SearchFiltersModel.SearchFiltersModelOneColumn, customSession, repository, siteAnalyticsLogger, null);
        ...
        #region GetSearchResultsModel
        public static List<SearchResultModelOneColumn> GetSearchResultsModel(List<CloudApplication> searchResults, ICustomSession customSession)
        {
            int i = 0;
...
;
        ...
        public static IQueryable<CompareCloudware.Domain.Models.CloudApplication> SearchProducts(SearchFiltersModelOneColumn model, ICustomSession customSession, ICompareCloudwareRepository repository, ISiteAnalyticsLogger siteAnalyticsLogger, params string[] keywords)
        {
        ...
        public static IPagedList<CloudApplication> PaginateSearchResults(IQueryable<CloudApplication> searchResultsForModel, int pageNumber)
        {
            int pageSize = SEARCH_RESULTS_PER_PAGE;
            var retVal = searchResultsForModel.ToPagedList(pageNumber, pageSize);
            return retVal;
        }
