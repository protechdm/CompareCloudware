...
{
    #region CloudApplicationApplication
    public class CloudApplicationApplication
    {
        public virtual int CloudApplicationApplicationID { get; set; }
        ...
        public virtual Status CloudApplicationApplicationStatus { get; set; }
    }
    #endregion
}
