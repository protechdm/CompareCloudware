...
{
    public static class AdvertisingImageDataOLD
    {
        public static bool PumpAdvertisingImageData(QueryRepository repository)
        {
            string MPU_FILEPATH = "J:\\CompareCloudwareVideo\\CompareCloudware.Web\\Images\\MPUs\\";
            ...
            string MPU_FILE42 = "1&1_MPU_V2.jpg"; //EMAIL 95
            ...
            // 9/7/2014
            string MPU_FILE59 = "accountsextra_MPU.jpg"; //CRM 6
            ...
            int MPU_FILE42_CLOUDAPPLICATIONID = 95;
            ...
            int MPU_FILE55_CLOUDAPPLICATIONID = 0;
            int MPU_FILE56_CLOUDAPPLICATIONID = 444;
            int MPU_FILE57_CLOUDAPPLICATIONID = 448;
            int MPU_FILE58_CLOUDAPPLICATIONID = 6;

            // 9/7/2014
            int MPU_FILE59_CLOUDAPPLICATIONID = 454;


            string SKYSCRAPER_FILEPATH = "J:\\CompareCloudwareVideo\\CompareCloudware.Web\\Images\\Skyscrapers\\";
            ...
            string SKYSCRAPER_FILE39 = "sage one_ss.gif"; //FINANCE 100
            ...
            //9/7/2014
            string SKYSCRAPER_FILE45 = "accountsextra_skyscraper.jpg"; //CRM 6
            ...
            int SKYSCRAPER_FILE41_CLOUDAPPLICATIONID = 0;
            ...
            // 9/7/2014
            int SKYSCRAPER_FILE45_CLOUDAPPLICATIONID = 454;
            ...
            ai = new AdvertisingImage()
            {
                ...
                AdvertisingImageType = repository.FindAdvertisingImageTypeByName("MPU"),
                AdvertisingImageStatus = repository.FindStatusByName("LIVE"),
                Category = repository.FindCategoryByName("FINANCE"),
