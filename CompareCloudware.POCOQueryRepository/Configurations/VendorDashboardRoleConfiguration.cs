...
{
    public class VendorDashboardRoleConfiguration : EntityTypeConfiguration<VendorDashboardRole>
    {
        public VendorDashboardRoleConfiguration()
        {
            ToTable("VendorDashboardRoles");
