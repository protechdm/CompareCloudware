...
namespace CompareCloudware.POCOQueryRepository.Configurations
{
    public class VendorConfiguration : EntityTypeConfiguration<Vendor>
    {
        public VendorConfiguration()
        {
            ...
            //Property(d => d.VendorStatus).IsRequired();
            //this.HasRequired(x => x.VendorStatus).WithRequiredDependent().WillCascadeOnDelete(false);
            this.HasRequired(x => x.VendorStatus);
